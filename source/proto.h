...
#include <string.h> /* for memset to get rid of a bunch of warnings */
#else
# define P(s) ()
#endif
...
#ifndef NOCONTROLS
void ExecuteDisplay P((VidStream *vid_stream , int frame_increment ));
#else
...
void MakeControlBar P((void ));
void UpdateFrameTotal P((void ));
void UpdateControlDisplay P((void ));
void ControlBar P((void ));
void ControlLoop P((VidStream *theStream ));
#endif /* !NOCONTROLS */
